...
#define	REG_ARRAY_SIZE 		(uint32_t)132
...
#define	LPMS_MAG_ALIG_BIAS_X 	(REG_START_ADDRESS + 126)
#define	LPMS_MAG_ALIG_BIAS_Y 	(REG_START_ADDRESS + 127)
#define	LPMS_MAG_ALIG_BIAS_Z 	(REG_START_ADDRESS + 128)
...
#define SET_MAG_ALIGNMENT_MATRIX	(COMMAND_START_ADDRESS + 75)
#define SET_MAG_ALIGNMENT_BIAS		(COMMAND_START_ADDRESS + 76)
#define SET_MAG_REFRENCE		(COMMAND_START_ADDRESS + 77)
#define GET_MAG_ALIGNMENT_MATRIX	(COMMAND_START_ADDRESS + 78)
#define GET_MAG_ALIGNMENT_BIAS		(COMMAND_START_ADDRESS + 79)
#define GET_MAG_REFERENCE		(COMMAND_START_ADDRESS + 80)
#define RESET_ORIENTATION_OFFSET	(COMMAND_START_ADDRESS + 81)	
