...
#define RS232_PORT USART1
#define RS232_DR_ADDRESS ((uint32_t)USART1 + 0x04) 
#define RS232_DMA_PORT DMA2
#define RS232_DMA_CLK RCC_AHB1Periph_DMA2
#define RS232_TX_DMA_CHANNEL DMA_Channel_4
#define RS232_RX_DMA_CHANNEL DMA_Channel_4
#define RS232_TX_DMA_STREAM DMA2_Stream7
#define RS232_RX_DMA_STREAM DMA2_Stream5
