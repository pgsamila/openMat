...
#define	REG_ARRAY_SIZE 		(uint32_t)128
...
#define LPMS_GYR_TEMP_CAL_PRM_A_X 	(REG_START_ADDRESS + 103)
#define LPMS_GYR_TEMP_CAL_PRM_A_Y 	(REG_START_ADDRESS + 104)
#define LPMS_GYR_TEMP_CAL_PRM_A_Z 	(REG_START_ADDRESS + 105)
#define LPMS_GYR_TEMP_CAL_PRM_B_X 	(REG_START_ADDRESS + 106)
#define LPMS_GYR_TEMP_CAL_PRM_B_Y 	(REG_START_ADDRESS + 107)
#define LPMS_GYR_TEMP_CAL_PRM_B_Z 	(REG_START_ADDRESS + 108)
#define LPMS_GYR_TEMP_CAL_BASE_V_X 	(REG_START_ADDRESS + 109)
#define LPMS_GYR_TEMP_CAL_BASE_V_Y 	(REG_START_ADDRESS + 110)
#define LPMS_GYR_TEMP_CAL_BASE_V_Z 	(REG_START_ADDRESS + 111)
#define LPMS_GYR_TEMP_CAL_BASE_T 	(REG_START_ADDRESS + 112)
#define LPMS_RAW_DATA_LP 		(REG_START_ADDRESS + 113)
#define LPMS_CAN_MAPPING 		(REG_START_ADDRESS + 114)
#define LPMS_CAN_HEARTBEAT 		(REG_START_ADDRESS + 122)
#define LPMS_LIN_ACC_COMP_MODE 		(REG_START_ADDRESS + 123)
#define LPMS_CENTRI_COMP_MODE 		(REG_START_ADDRESS + 124)
#define LPMS_CAN_CONFIGURATION 		(REG_START_ADDRESS + 125)
...
#define SET_OFFSET 			(COMMAND_START_ADDRESS + 18)	
...
#define LPMS_STREAM_T_5HZ 	(uint32_t)198000
#define LPMS_STREAM_T_10HZ 	(uint32_t)98000
#define LPMS_STREAM_T_30HZ 	(uint32_t)31000
#define LPMS_STREAM_T_50HZ 	(uint32_t)18000
#define LPMS_STREAM_T_100HZ 	(uint32_t)8000
#define LPMS_STREAM_T_200HZ 	(uint32_t)2500
#define LPMS_STREAM_T_300HZ	(uint32_t)1
#define LPMS_STREAM_T_500HZ 	(uint32_t)1
#define LPMS_STREAM_T_1000HZ 	(uint32_t)1
...
#define LPMS_LIN_ACC_COMP_MODE_STRONG		0x00000002
