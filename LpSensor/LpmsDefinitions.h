...
#define SELECT_STREAM_FREQ_300HZ 		300
#define SELECT_STREAM_FREQ_500HZ 		500
#define SELECT_STREAM_FREQ_1000HZ 		1000
...
#define SELECT_LPMS_LP_OFF 						0x00000000
#define SELECT_LPMS_LP_01 						0x00000001
#define SELECT_LPMS_LP_005 						0x00000002
#define SELECT_LPMS_LP_001 						0x00000003
#define SELECT_LPMS_LP_0005 					0x00000004
#define SELECT_LPMS_LP_0001 					0x00000005

#define SELECT_LPMS_CAN_HEARTBEAT_005			0x00000000
#define SELECT_LPMS_CAN_HEARTBEAT_010			0x00000001
#define SELECT_LPMS_CAN_HEARTBEAT_020			0x00000002
#define SELECT_LPMS_CAN_HEARTBEAT_050			0x00000003
#define SELECT_LPMS_CAN_HEARTBEAT_100			0x00000004
...
#define SELECT_LPMS_LIN_ACC_COMP_MODE_OFF			0x00000000
#define SELECT_LPMS_LIN_ACC_COMP_MODE_WEAK			0x00000001
#define SELECT_LPMS_LIN_ACC_COMP_MODE_MEDIUM		0x00000002
#define SELECT_LPMS_LIN_ACC_COMP_MODE_STRONG		0x00000003
#define SELECT_LPMS_LIN_ACC_COMP_MODE_ULTRA			0x00000004

#define SELECT_LPMS_CENTRI_COMP_MODE_OFF			0x00000000
#define SELECT_LPMS_CENTRI_COMP_MODE_ON			0x00000001

#define SELECT_CAN_POINT_MODE_FIXED				0x00000001
#define SELECT_CAN_POINT_MODE_FLOATING			0x00000000

#define SELECT_CAN_CHANNEL_MODE_SEQUENTIAL		0x00000001
#define SELECT_CAN_CHANNEL_MODE_CANOPEN			0x00000000

#define SELECT_LPMS_LPBUS_DATA_MODE_32			0x00000000
#define SELECT_LPMS_LPBUS_DATA_MODE_16			0x00000001
